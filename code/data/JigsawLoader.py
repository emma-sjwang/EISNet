...
class JigsawDataset(data.Dataset):
    def __init__(self, names, labels, jig_classes=30, img_transformer=None, tile_transformer=None, patches=True, bias_whole_image=None):
        self.data_path = ""
        self.names = names
        self.labels = labels
    ...
    def __getitem__(self, index):
        ...
        return torch.cat([self._augment_tile(img), data], 0), order, int(self.labels[index])
