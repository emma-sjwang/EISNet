...
from data.JigsawLoader import BaselineDataset, JigsawDataset, JigsawTestDataset, get_split_dataset_info, _dataset_info, JigsawTestDatasetMultiple
...
def get_baseline_train_dataloader(args):
    ...
    for dname in dataset_list:
        ...
        train_dataset = BaselineDataset(name_train, labels_train, img_transformer=img_transformer,
                                      tile_transformer=tile_transformer, two_transform=True)
        if limit:
            train_dataset = Subset(train_dataset, limit)
        datasets.append(train_dataset)
        val_datasets.append(
            BaselineDataset(name_val, labels_val, img_transformer=get_val_transformer(args), two_transform=False))
...
def get_val_transformer(args):
    img_tr = [transforms.Resize(args.image_size), transforms.ToTensor(),
